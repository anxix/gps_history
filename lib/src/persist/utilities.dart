...
class ReadonlyCollectionException extends GpsHistoryException {
  ReadonlyCollectionException([String? message]) : super(message);
}
...
class NotEmptyCollectionException extends GpsHistoryException {
